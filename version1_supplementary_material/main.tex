...
\title{Supplementary Document for ``The Importance of the Diversity on Variable Space in the Design of Multi-objective Evolutionary Algorithms''}
%
%
...
Callej\'on Jalisco s/n, Mineral de Valenciana, Guanajuato, Guanajuato 36240, Mexico (e-mail: joelchaconcastillo@gmail.com; carlos.segura@cimat.mx)}%
...
% The paper headers
\markboth{IEEE Transactions on Evolutionary Computation,~Vol.~XX, No.~X, Month~Year}{Chacon et al.:
A Multi-objective Evolutionary Algorithm based on Decomposition with Explicit Management of Variable Space Diversity}
...
%%
%Usually, only when the aim is to attain diverse solutions in the variable space, these kinds
%of mechanisms are considered.
%%
%This is a remarkable difference with respect to single-objective optimizers, where
%even when no diverse solutions are required, the benefits of controlling
%diversity are well-known.
%%
...
%%
%A novel MOEA based on decomposition (VSD-MOEA/D) that uses these principles through a novel replacement phase is
%devised.
%%
...
%\end{IEEEbiography}
%
%\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip]{Photo_Authors/oliver.eps}}]{Oliver Sch\"{u}tze}
