...
\title{A Multi-objective Decomposition Algorithm Based in Variable Space Diversity}
%
%
...
%\author{Carlos~Segura,~\IEEEmembership{Member,~IEEE}, Joel~Chac\'on~Castillo,
...
%\author{Carlos~Segura~\IEEEmembership{Member,~IEEE,}
%        ~and~Joel~Chac\'on%~\IEEEmembership{Fellow,~OSA,}
...
\begin{abstract}
In the last decade the presence of Multi-Objective Evolutionary Algorithms (MOEAs) has grown remarkably.
%
Mostly, the MOEAs incorporate components to directly improve the quality in the objective space, which implicitly involves the decision variable space.
%
Nevertheless, to attain even better quality solutions, the decision variable space should be explicitly taken into account as part of the design process.
%
In this way the balance between exploration and intensification could be directly induced.
%
A quite popular strategy that provides such balance yields in the incorporation of a novel replacement operator.
%
This operator explictly promotes diversity in the decision variable space through several stages along the optimization process.
%
In this work a decomposition based MOEA (VSD-MOEA/D), which incorporates this replacement operator, is proposed.
%
In addition, through several experiments, is empirically proved that as the number of obejctives is increased, the diversity degree required in the decision variable space should be less.
%
Even more, our proposal attained better results than the state-of-the-art MOEAs increasing the number of decision variables.
%
...
\begin{IEEEkeywords}
Evolutionary Algorithms, Multi-objective, Decomposition, Diversity. 
\end{IEEEkeywords}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip]{Photo_Authors/segura.eps}}]{\bf Carlos Segura} (M'13) was born in Santa Cruz de Tenerife, Spain, on August 03, 1983.
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip]{Photo_Authors/joel.eps}}]{Joel Chac\'on}
...
the Center for Reseach in Mathematics, M\'exico.

He has participated in several international conferences with works highly related to the management of diversity
in evolutionary algorithms.

%
He is currently working toward the Ph.D. degree, and his current research interests are multi-objective optimization, memetic algorithms,
