...
%
Only when the aim is to attain diverse solutions in the variable space, these kinds
of mechanisms are usually considered.
%
This is a remarkable difference with respect to single-objective optimizers, where
even when no diverse solutions are required, the benefits of integrating mechanisms to control
...
granted to the diversity on the objective space and variable space,
...
devised.
%
Extensive experimentation shows the clear benefits of our proposal against the state of the art.
\end{abstract}
