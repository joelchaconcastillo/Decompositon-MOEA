This section is devoted to carry out the validation of our proposal against state-of-the-art \MOEAS{} and
to explain the reasons behind the superiority of \VSDMOEA{}.
%
...
First, a comparison between \VSDMOEA{} and four state-of-the-art \MOEAS{} is included.
%
This comparison focuses on showing the benefits of \VSDMOEA{} for benchmarks 
configured in standard ways.
%
Second, an analysis to test the scalability on the number of decision variables is carried out.
%
Finally, the robustness of \VSDMOEA{} in terms of the initial penalty threshold is analyzed.
%
...
the implications of \VSDMOEA{} on the diversity on variable space.
%
These analyses allow to better understand the reasons behind the proper performance of \VSDMOEA{}
and to highlight the significant differences between \VSDMOEA{} and other strategies in terms of the dynamics
of the population.
...
\begin{table}[t]
\centering
\caption{Parameterizaon of the variation phase applied in each \MOEA{}}
\label{tab:tunning}
%\resizebox{\textwidth}{!}{%
\begin{tabular}{c|c|c|c|c|c|c}
\hline
\multirow{2}{*}{}   & \multicolumn{3}{c|}{\textbf{2 objectives}} & \multicolumn{3}{c}{\textbf{3 objectives}} \\ \cline{2-7} 
                    & $CR$                 & $F$                 & $p_m$                & $CR$                 & $F$              & $p_m$             \\ \hline
\textbf{VSD-MOEA/D} & 0.0                  & 0.75                & $1 / {D}$            & 0.0                  & 0.75             & $1 / D$           \\ \hline
\textbf{MOEA/D-DE}  & 0.75                 & 0.75                & $1 / {D}$            & 0.5                  & 0.5              & $1 / {D}$         \\ \hline
\textbf{R2-EMOA}    & 0.75                 & 0.5                 & $0$                  & 0.5                  & 0.5              & $0$               \\ \hline
\textbf{NSGA-II}    & 0.75                 & 0.5                 & $0$                  & 0.0                  & 0.5              & $0$               \\ \hline
\textbf{NSGA-III}   & 0.5                  & 0.5                 & $0$                  & 0.5                  & 0.5              & $0$               \\ \hline
\end{tabular}%
%}
\end{table}
...
will all the aforementioned benchmarks and the mean attained hypervolume value were calculated independently
...
%
Table~\ref{tab:tunning} reports the configuration selected for each of the \MOEAS{}.
%
Note that in the case of \VSDMOEAD{}, $CR$ was set to 0 which reduces the strength of the perturbation performed
by \DE{}.
%
The reason behind this is that \VSDMOEAD{} maintains a larger degree of diversity than other methods, so disruptive
...
%
Note also that scalarization functions are used in \MOEADDE{}, \RMOEA{}, \NSGAIII{} and \VSDMOEAD{}.
%
