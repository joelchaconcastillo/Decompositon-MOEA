...
%
Note that in the case of \AVSDMOEAD{} a second set of weight vectors ($\Lambda$) is considered for the external archive.
%
Since the archive is based on $R2$, it considers the same weight vectors than \RMOEA{}.
...
\end{tabular}
\caption{Diversity of distance variables (top) and mean of \HV{} ratios (bottom) vs. elapsed time in the bi-objective WFG5 test problem. The reported results are taken from $35$ runs.}\label{fig:WFG5_Diversity}
\end{figure}
...
\end{tabular}
\caption{Diversity of distance variables (top) and mean of \HV{} ratios (bottom) vs. elapsed time in the bi-objective UF5 test problem. The reported results are taken from $35$ runs.}\label{fig:UF5_Diversity}
\end{figure}
...
%
Moreover, in the UF5 the optimal regions are isolated on the variable 
...
In order to have a better insight on the benefits of our proposal, an analysis of the scalability in terms of the number 
...
\end{tabular}
\caption{Diversity of distance variables (top) and mean of \HV{} ratios (bottom) vs. elapsed time in the two-objective WFG9 test problem. The reported results are taken from $35$ runs.}\label{fig:WFG9_Diversity}
\end{figure}
